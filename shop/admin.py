...
class productAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Цена', {
            'fields': ('цена', 'валюта', 'скидка', 'оптовая_цена', )
        }),
        ('Информация о товаре', {
            'fields': ('наличие' ,'единица_измерения', 'минимальный_объем_заказа', 'минимальный_заказ_опт', 'страна_производитель', 'личные_заметки',)
        }),

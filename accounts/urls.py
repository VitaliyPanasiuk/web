...
from .views import register, login, logout, userProfilePage, userOrders, userCart, userFavourites, editProfilePage, editPasswordPage, makeOrder, editOrder, success_order
...
urlpatterns = [
    ...
    path('<int:uid>/order/<int:oid>', editOrder),
